...
import cl.bice.coe.bamboospecs.models.BambooYamlFileModel;
import cl.bice.coe.bamboospecs.support.JUnitResultHelper;
...
public class BiceSpecs {
    private static final Logger LOGGER = LoggerFactory.getLogger(BiceSpecs.class);
    private final JUnitResultHelper resultHelper;

    public static void main(final String[] args) throws Exception {
        BiceSpecs specs = new BiceSpecs();
        specs.runSpecs(args);
    }
    ...
    BiceSpecs(JUnitResultHelper resultHelper) {
    ...
    private void runSpecs(String[] args) throws ParseException {
        ...
        if (cmd.getArgList().isEmpty()) {
            printHelp(options);
            throw new RuntimeException("Error: No se encuentra(n) el o los archivo(s)");
        }
    ...
    private static void printHelp(Options options) {
        ...
        formatter.printHelp("bice-specs [options] <yaml file> ...", "options:", options, "");
    }
}
